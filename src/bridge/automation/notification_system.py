...
class NotificationSystem:
    ...
    def _setup_default_channels(self):
        ...
        self.channels["console"] = ChannelConfig(
            channel_type=NotificationChannel.CONSOLE, config={}, enabled=True
        )
                ...
                "attachments": [
                    {
                        ...
                        "fields": [
                            {"title": "우선순위", "value": message.priority.value, "short": True},
                            {
                                "title": "시간",
                                "value": (message.sent_at or datetime.now()).strftime(
                                    "%Y-%m-%d %H:%M:%S"
                                ),
                                "short": True,
                            },
    ...
    def get_messages(
        ...
        filtered_messages = [
            msg for msg in self.messages if msg.sent_at is None or msg.sent_at >= cutoff_time
        ]
