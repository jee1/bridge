...
from bridge.analytics.core import UnifiedDataFrame, QualityChecker, StatisticsAnalyzer
from bridge.governance.contracts import DataContract, ContractValidator
...
class QualityMonitor:
    ...
    def add_monitoring_task(self, task_id: str, data_source: str, table_name: str,
    ...
    def _check_thresholds(self, task_id: str, task_config: Dict[str, Any], 
                         quality_report: Any):
        """임계값 확인"""
    ...
    def _create_alert(self, threshold: QualityThreshold, current_value: float,
                     task_config: Dict[str, Any]) -> QualityAlert:
        """알림 생성"""
        import uuid
    ...
    def get_monitoring_status(self) -> Dict[str, Any]:
        """모니터링 상태 조회"""
        last_checks = [task.get("last_check") for task in self.monitoring_tasks.values() if task.get("last_check")]
