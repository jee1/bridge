            ...
            if result.explained_variance_ratio is not None:
                for i in range(result.n_components):
                    component = ComponentInfo(
                        ...
                        cumulative_variance_ratio=result.cumulative_variance_ratio[i] if result.cumulative_variance_ratio is not None else None,
                        feature_importance=result.feature_importance[i] if result.feature_importance is not None else None
                    )
