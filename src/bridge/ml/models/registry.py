...
class ModelRegistry:
    ...
    def update_model(self, model_id: str, updates: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            # 업데이트 가능한 필드들만 업데이트
            updatable_fields = {
                'description', 'status', 'performance_metrics', 
                'hyperparameters', 'tags', 'model_path', 'dependencies'
            }
    ...
    def get_model_by_name(self, name: str, version: Optional[str] = None) -> Optional[ModelContract]:
        """이름으로 모델 조회
