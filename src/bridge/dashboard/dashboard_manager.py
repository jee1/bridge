...
class DashboardManager:
    ...
    def delete_dashboard(self, dashboard_id: str) -> bool:
        ...
        try:
            # 관련 위젯들도 삭제
            dashboard_widgets = [w for w in self.widgets.values() 
                               if w.data_source == dashboard_id]
    ...
    def remove_widget(self, widget_id: str, dashboard_id: str) -> bool:
        ...
        try:
            ...
            if 'widgets' in self.dashboards[dashboard_id]:
                self.dashboards[dashboard_id]['widgets'] = [
                    w for w in self.dashboards[dashboard_id]['widgets'] 
                    if w != widget_id
                ]
    ...
    def get_dashboard_widgets(self, dashboard_id: str) -> List[DashboardWidget]:
        ...
        return [self.widgets[widget_id] for widget_id in widget_ids 
    ...
    def get_dashboard_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widgets_by_type": {
                widget_type.value: len([w for w in self.widgets.values() 
                                      if w.widget_type == widget_type])
                for widget_type in WidgetType
            },
            "dashboards_by_theme": {
                theme: len([d for d in self.dashboards.values() 
