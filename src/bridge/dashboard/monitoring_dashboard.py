...
class MonitoringDashboard:
    ...
    def _check_thresholds(
        self, system_metrics: SystemMetrics, performance_metrics: PerformanceMetrics
    ):
        """임계값 확인 및 알림 생성"""
        # CPU 임계값 확인
        self._check_metric_threshold(MetricType.CPU, system_metrics.cpu_percent, "CPU 사용률")
        ...
        self._check_metric_threshold(MetricType.APPLICATION, response_time_seconds, "응답시간")
    ...
    def get_metrics_history(self, hours: int = 1) -> Dict[str, List[Dict[str, Any]]]:
        ...
        system_history = [
            metric.to_dict() for metric in self.system_metrics if metric.timestamp >= cutoff_time
        ]
        ...
        return {"system": system_history, "performance": performance_history}
    ...
    def get_dashboard_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_status": {
                ...
                "response_time": (
                    current_metrics.get("performance", {}).get("response_time", 0)
