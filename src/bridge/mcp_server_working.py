...
async def main():
    ...
    logger.info("Starting Working Bridge MCP Server...")

    bridge_server = WorkingBridgeMCPServer()
    logger.info("Working Bridge MCP Server initialized")
