...
class StatisticsAnalyzer:
    ...
    def calculate_descriptive_stats(self, df: UnifiedDataFrame, 
                                  columns: Optional[List[str]] = None) -> Dict[str, DescriptiveStats]:
        """기술 통계를 계산합니다.
    ...
    def calculate_correlation(self, df: UnifiedDataFrame, 
    ...
    def calculate_distribution_stats(self, df: UnifiedDataFrame, 
    ...
    def generate_summary_report(self, df: UnifiedDataFrame, 
