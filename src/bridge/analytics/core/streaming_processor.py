...
class StreamingProcessor:
    ...
    def aggregate_streaming_results(
        self,
        processed_chunks: Iterator[pa.Table],
    ...
    def optimize_chunk_size(self, table: pa.Table) -> int:
        ...
        logger.info(f"최적 청크 크기 계산: {optimal_chunk_size} (테이블 크기: {table_size / (1024*1024):.2f}MB)")
    ...
    def get_memory_usage(self, table: pa.Table) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_efficiency": "good" if total_size < self.memory_limit_bytes else "needs_optimization"
        }
