...
class AdvancedStatistics:
    ...
    def descriptive_statistics(
        ...
        for column in numeric_columns:
            ...
            if include_skewness:
                ...
                stats_dict["skewness_interpretation"] = self._interpret_skewness(
                    stats_dict["skewness"]
                )

            if include_kurtosis:
                stats_dict["kurtosis"] = series.kurtosis()
                stats_dict["kurtosis_interpretation"] = self._interpret_kurtosis(
                    stats_dict["kurtosis"]
                )
    ...
    def distribution_analysis(
        self, data: UnifiedDataFrame, columns: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        """분포 분석을 수행합니다.
    ...
    def _mann_whitney_test(
        self, df: pd.DataFrame, column1: str, column2: str, alpha: float
    ) -> Dict[str, Any]:
    ...
    def _anova_test(
        self, df: pd.DataFrame, column: str, group_column: str, alpha: float
    ) -> Dict[str, Any]:
        """ANOVA 검정을 수행합니다."""
