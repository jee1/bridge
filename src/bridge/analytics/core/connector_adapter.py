...
class ConnectorAdapter:
    ...
    async def execute_query(self, query: str, params: Dict[str, Any] = None) -> UnifiedDataFrame:
    ...
    def __repr__(self) -> str:
        """문자열 표현."""
        return f"ConnectorAdapter(connector={self.connector.name}, normalize={self.normalize_types})"
