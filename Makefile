...
help:
	...
	@echo "  make c1-help           - C1 마일스톤 명령어 도움말"
	@echo "  make test-help         - 테스트 명령어 도움말"
	@echo ""
	@echo "💡 사용 예시:"
	@echo "  make install && make dev-full-up  # 초기 설정 후 전체 환경 시작"
	@echo "  make dev-test                      # 개발 중 빠른 테스트"
	@echo "  make pr-test                       # PR 전 전체 테스트"
	@echo "  make c1-test-full                  # C1 마일스톤 전체 테스트"
