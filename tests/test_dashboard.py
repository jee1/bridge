...
from src.bridge.dashboard import (
    ...
    MonitoringDashboard, SystemMetrics, PerformanceMetrics,
    RealTimeMonitor, MetricCollector, AlertManager,
    VisualizationEngine, ChartRenderer, LayoutManager
)
from src.bridge.dashboard.dashboard_manager import WidgetType, LayoutType
from src.bridge.dashboard.monitoring_dashboard import MetricType, AlertLevel
from src.bridge.dashboard.real_time_monitor import ConnectionStatus
from src.bridge.dashboard.visualization_engine import ChartType, ChartConfig, LayoutConfig, LayoutType
...
class TestRealTimeMonitor(unittest.TestCase):
    ...
    def test_add_remove_connection(self):
        ...
        self.assertEqual(self.monitor.get_connection_status(client_id), ConnectionStatus.DISCONNECTED)
