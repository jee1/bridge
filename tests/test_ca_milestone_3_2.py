...
class TestAdvancedVisualization:
    ...
    def test_create_interactive_chart_line(self):
        """선 차트 생성 테스트."""
        result = self.viz.create_advanced_chart(
            self.df, "line", "x", "y", title="Test Line Chart"
        )
    ...
    def test_create_interactive_chart_histogram(self):
        """히스토그램 생성 테스트."""
        result = self.viz.create_advanced_chart(
            self.df, "histogram", "y", title="Test Histogram"
        )
    ...
    def test_generate_report(self):
        ...
        result = self.viz.create_advanced_report(
            self.df, analysis_config, "Test Report"
        )
...
class TestTimeSeriesAnalysis:
    ...
    def test_forecast_time_series(self):
        """시계열 예측 테스트."""
        result = self.analyzer.forecast_time_series(
            self.df, "date", "value", 12, "linear"
        )
    ...
    def test_analyze_anomalies(self):
        """이상치 분석 테스트."""
        result = self.analyzer.analyze_anomalies(
            self.df, "date", "value", "zscore", 3.0
        )
...
class TestIntegration:
    ...
    def test_end_to_end_analysis(self):
        ...
        stats_result = stats_analyzer.descriptive_statistics(
            self.df, ["value", "score"]
        )
        ...
        ts_result = ts_analyzer.detect_trend(
            self.df, "timestamp", "value", "linear"
        )
