...
class TestDataUnifier:
    ...
    def test_unify_simple_data_sources(self):
        ...
        # 테스트 데이터 준비
        data_sources = {
            "source1": [{"id": 1, "name": "Alice", "age": 25}, {"id": 2, "name": "Bob", "age": 30}],
            "source2": [
    ...
    def test_unify_with_schema_mapping(self):
        ...
        # 스키마 매핑 정의
        schema_mapping = {"source1": {"user_id": "id", "user_name": "name", "user_age": "age"}}
...
class TestSchemaMapper:
    ...
    def test_create_mapping(self):
        ...
        # 매핑 규칙 정의
        mapping_rules = {"user_id": "id", "user_name": "name", "user_age": "age"}
...
class TestTypeConverter:
    ...
    def test_add_custom_conversion_rule(self):
        ...
        custom_rule = ConversionRule(
            source_type="string", target_type="int64", conversion_function="cast", parameters={}
        )
...
class TestStreamingProcessor:
    ...
    def test_process_large_table(self):
        ...
        # 테스트 데이터 생성
        test_data = [{"id": i, "name": f"User{i}", "age": 20 + i} for i in range(10)]
    ...
    def test_get_memory_usage(self):
        ...
        # 테스트 데이터
        test_data = [{"id": 1, "name": "Alice", "age": 25}, {"id": 2, "name": "Bob", "age": 30}]
...
class TestIntegratedDataLayer:
    ...
    def test_apply_data_transformations(self):
        ...
        # 변환 규칙 정의
        transformations = [
            {"type": "column_rename", "column_mapping": {"id": "user_id", "name": "user_name"}}
        ]
