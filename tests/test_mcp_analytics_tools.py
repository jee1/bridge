...
class TestMCPAnalyticsTools(unittest.TestCase):
    ...
    def test_statistics_analyzer_descriptive(self):
        ...
        async def run_test():
            args = {"data": self.test_data, "analysis_type": "descriptive"}
    ...
    def test_statistics_analyzer_correlation(self):
        ...
        async def run_test():
            args = {"data": self.test_data, "analysis_type": "correlation"}
            result = await self.server._statistics_analyzer(args)
    ...
    def test_data_profiler(self):
        ...
        async def run_test():
            args = {"data": self.test_data, "include_stats": True, "include_quality": True}
    ...
    def test_outlier_detector_iqr(self):
        ...
        async def run_test():
            args = {"data": self.test_data, "method": "iqr", "columns": ["value1", "value2"]}
    ...
    def test_outlier_detector_zscore(self):
        ...
        async def run_test():
            args = {"data": self.test_data, "method": "zscore", "threshold": 2.5}
            result = await self.server._outlier_detector(args)
    ...
    def test_invalid_analysis_type(self):
        ...
        async def run_test():
            args = {"data": self.test_data, "analysis_type": "invalid_type"}
            result = await self.server._statistics_analyzer(args)
    ...
    def test_empty_data(self):
        ...
        async def run_test():
            args = {"data": {}, "analysis_type": "descriptive"}
            result = await self.server._statistics_analyzer(args)
